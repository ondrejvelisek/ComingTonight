...
class NearbyPlacesServiceStatic : NearbyPlacesService {
    ...
    private val places = listOf(
            Activity("Kravi Hora", 3.9, Category.OUTDOOR, null, IMAGE_URI),
            Activity("Spilberk", 4.5, Category.INDOOR, null, IMAGE_URI),
            Activity("Lužánky Park", 4.4, Category.OUTDOOR, null, IMAGE_URI)
    )
