...
class TvProgramServiceStatic : TvProgramService {
    ...
    private val movies = listOf(
            Activity("Lord of The ring", 8.9, Category.HOME, null, IMAGE_URI),
            Activity("Simpsons XXVII.", 8.0, Category.HOME, null, IMAGE_URI),
            Activity("Game of Thronmes", 7.3, Category.HOME, null, IMAGE_URI)
    )
